...
<html lang="en">
	<head>
		...
		<meta charset="UTF-8">
		<title><a href="">Garleton Academy</a>
		</title>
		<link rel="stylesheet"
			href="/Garleton/bootstrap3.3.6/dist/css/bootstrap.min.css">
	...
	<body>
		<div id="curtain">
			...
			<div class="wrapper">
				...
				<form method="post" id="sign_up_form" action="userAction!reg"
					...
					<input type="password" placeholder="密码" name="pwd" id="first_pwd">
					<br />
					<input type="password" placeholder="重新输入密码" id="second_pwd">
					<br />
					...
					<input type="text" placeholder="单位" name="unit">
					<br />
					<input type="text" placeholder="电话" name="tel">
					<br />
					<input type="text" placeholder="手机" name="cel">
					<br />
		...
		<div id="footer_info">
			...
			<address>
				<ul>
					<li>
						<span>联系电话：<a href="">15950570536</a>
						</span>
					</li>
					<li>
						<span>地址：<a href="">南京大学南园4舍</a>
						</span>
					</li>
					<li>
						<span>邮箱：<a href="">ybbdaidai@126.com</a>
						</span>
					</li>
				</ul>
			</address>
